@component('admin.management.layouts.content')
    ...
    <form action="{{ route('admin.attribute.update', $attribute->id) }}" method="POST">
        ...
        <div class="create-city">
            <p class="title">ایجاد ویژگی</p>
            <div class="city-table">
                <p>عنوان</p>
                <input name="title" type="text" placeholder="عنوان راوارد کنید" value="{{ $attribute->title }}"/>
                <p>توضیحات</p>
                <input name="description" type="text" placeholder="توضیحات بیشتر" value="{{ $attribute->description }}"/></br>
