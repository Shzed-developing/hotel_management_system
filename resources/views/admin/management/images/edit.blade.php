    ...
    <form action="{{ route('admin.image.update', $image->id) }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="create-city">
            ...
            <div class="city-table">
                ...
                <p>نامک</p>
                <input type="text" name="label" placeholder="نام شهر را به انگلیسی وارد کنید" value="{{ $image->label }}"/>
                <p>استان</p>
                <input type="text" name="state" placeholder="استان" value="{{ $image->state }}"/></br>
