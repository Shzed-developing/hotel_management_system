        ...
        <nav>
            <ul class="header-ul">
                <li class="more-menu" id="show-reservation-menu">
                    ...
                    <ul class="drop-down">
                        <li><a href="{{ route('admin.city.gillan') }}">گیلان</a></li>
                        <li><a href="{{ route('admin.city.isfahan') }}">اصفهان</a></li>
                        <li><a href="{{ route('admin.city.mashhad') }}">مشهد</a></li>
                        <li><a href="{{ route('admin.city.kish') }}">کیش</a></li>
                        <li><a href="{{ route('admin.city.tehran') }}">تهران</a></li>
                        <li><a href="{{ route('admin.city.shiraz') }}">شیراز</a></li>
                    </ul>
                </li>
                <li>
                    <a href="#">پروفایل</a>
