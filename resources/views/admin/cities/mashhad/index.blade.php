    ...
    <div class="hotels">
        <div class="hotel-grid">
            <div class="hotel-1">
                ...
                <a href="{{ route('admin.city.mashhad.darvishi') }}"><h2>هتل مجلل درویشی </h2></a>
                <p>مشهد</p>
            ...
            <div class="hotel-2">
                ...
                <a href="{{ route('admin.city.mashhad.almas') }}"><h2>هتل الماس</h2></a>
                <p>مشهد</p>
            ...
            <div class="hotel-3">
                ...
                <a href="{{ route('admin.city.mashhad.boshra') }}"><h2>هتل بشری</h2></a>
                <p>مشهد</p>
