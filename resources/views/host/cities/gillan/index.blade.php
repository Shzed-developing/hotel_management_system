    ...
    <div class="hotels">
        <div class="hotel-grid">
            <div class="hotel-1">
                ...
                <a href="{{ route('host.city.gillan.jahan') }}"><h2>هتل جهانگردی</h2></a>
                <p>بندرانزلی</p>
            ...
            <div class="hotel-2">
                ...
                <a href="{{ route('host.city.gillan.pamchal') }}"><h2>هتل پامچال</h2></a>
                <p>بندرانزلی</p>
            ...
            <div class="hotel-3">
                ...
                <a href="{{ route('host.city.gillan.arka') }}"><h2>هتل آرکا</h2></a>
                <p>رشت</p>
