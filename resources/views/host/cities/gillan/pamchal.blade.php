@component('host.layouts.content')
    ...
    <div class="hotel1">
        ...
        <h5>رشت، بلوار امام خمینی، میدان مصلی</h5>
    </div>
    <div class="hotel-box">
        <div class="hotel-v">
            <h2>توضیحات</h2>
        ...
        <div class="images-h">
            <img src="/images/gilan3/pamchal-hotel.jpg">
            <img src="/images/gilan3/pamchal-hotel-18.jpg">
            <img src="/images/gilan3/4.jpg">
            <img src="/images/gilan3/16.jpg">
        </div>
        <div class="more-hotel">
            ...
            <div class="m-hotel">
                <img src="/images/gilan/jahangardi-hotel-anzali.jpg">
                <div class="text-h">
                    <p>450000 تومان/هر شب</p>
                    <a href="./jahan-gilan.html"><p>هتل جهانگردی</p></a>
                    <h5>بندرانزلی</h5>
                </div>
            </div>
        </div>
