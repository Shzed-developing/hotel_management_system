@component('host.layouts.content')
    ...
    <div class="hotel1">
        ...
        <h5>مشهد، خیابان امام رضا، بین امام رضا 20</h5>
    </div>
    <div class="hotel-box">
        <div class="hotel-v">
            <h2>توضیحات</h2>
            <p>این هتل در سال 1382 تاسیس شده است.</p>
            <h2>ویژگی ها</h2>
            <div class="icon-v">
        ...
        <div class="images-h">
            <img src="/images/mashhad2/photo_2023-07-30_14-14-50.jpg">
            <img src="/images/mashhad2/photo_2023-07-30_14-14-53.jpg">
            <img src="/images/mashhad2/photo_2023-07-30_14-15-07.jpg">
            <img src="/images/mashhad2/photo_2023-07-30_22-56-48.jpg">
        </div>
        <div class="more-hotel">
            <h3>هتل های بیشتر</h3>
            <div class="m-hotel">
                <img src="/images/mashhad2/photo_2023-07-30_14-14-40.jpg">
                <div class="text-h">
                    <p>650000 تومان/هر شب</p>
                    <a href="./darvishi-mashhad.html"><p>هتل مجلل درویشی</p></a>
                    <h5>مشهد</h5>
                </div>
            </div>
            <div class="m-hotel">
                <img src="/images/mashhad3/boshra-hotel-mashhad.jpg">
                <div class="text-h">
                    <p>800000 تومان/هر شب</p>
                    <a href="./boshra-mashhad.html"><p>هتل بشری</p></a>
                    <h5>مشهد</h5>
                </div>
            </div>
        </div>
