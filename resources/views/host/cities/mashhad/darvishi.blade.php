@component('host.layouts.content')
    ...
    @endslot
    <div class="hotel1">
        <h2>هتل مجلل درویشی</h2>
        <div class="starhotel">
            <img src="/images/star_2893811.png">
            <p>5ستاره</p>
        </div>
        <h5>مشهد، خیابان امام رضا، بین امام رضا 24و26</h5>
    </div>
    <div class="hotel-box">
        <div class="hotel-v">
            <h2>توضیحات</h2>
        ...
        <div class="images-h">
            <img src="/images/mashhad/photo_2023-07-30_14-09-22.jpg">
            <img src="/images/mashhad/photo_2023-07-30_14-09-26.jpg">
            <img src="/images/mashhad/photo_2023-07-30_14-09-47.jpg">
            <img src="/images/mashhad/photo_2023-07-30_14-09-55.jpg">
        </div>
        <div class="more-hotel">
            ...
            <div class="m-hotel">
                ...
                <div class="text-h">
                    ...
                    <a href="./almas-mashhad.html"><p>هتل الماس</p></a>
                    <h5>مشهد</h5>
                </div>
            </div>
            <div class="m-hotel">
