@component('host.layouts.content')
    ...
    <div class="hotel1">
        ...
        <h5>مشهد، خیابان خسروی نو، ابتدای بازار سرشور</h5>
    </div>
    <div class="hotel-box">
        <div class="hotel-v">
            <h2>توضیحات</h2>
            <p>این هتل در سال 1380 تاسیس شده است.</p>
            <h2>ویژگی ها</h2>
            <div class="icon-v">
        ...
        <div class="images-h">
            ...
            <img src="/images/mashhad3/photo_2023-07-30_22-57-37.jpg">
            <img src="/images/mashhad3/photo_2023-07-30_22-57-54.jpg">
            <img src="/images/mashhad3/photo_2023-07-30_22-58-07.jpg">
        </div>
