    ...
    <div class="hotels">
        <div class="hotel-grid">
            <div class="hotel-1">
                ...
                <a href="{{ route('host.city.isfahan.kosar') }}"><h2>هتل کوثر پارسیان</h2></a>
                <p>اصفهان</p>
            ...
            <div class="hotel-2">
                ...
                <a href="{{ route('host.city.isfahan.toloe') }}"><h2>هتل طلوع خورشید</h2></a>
                <p>اصفهان</p>
            ...
            <div class="hotel-3">
                ...
                <a href="{{ route('host.city.isfahan.pirozi') }}"><h2>هتل پیروزی</h2></a>
                <p>اصفهان</p>
