@component('host.layouts.content')
    ...
    @endslot
    <div class="hotel1">
        <h2>هتل طلوع خورشید</h2>
        <div class="starhotel">
            <img src="/images/star_2893811.png">
            <p>3ستاره</p>
        </div>
        <h5>اصفهان، خیابان ابن سینا، کوچه شماره ۳۷ (میر علاالدین)، فرعی ۳</h5>
    </div>
    <div class="hotel-box">
        <div class="hotel-v">
            <h2>توضیحات</h2>
        ...
        <div class="images-h">
            ...
            <img src="/images/esfahan2/photo_2023-07-30_23-10-47.jpg">
            <img src="/images/esfahan2/photo_2023-07-30_23-10-41.jpg">
            <img src="/images/esfahan2/photo_2023-07-30_23-10-32.jpg">
        </div>
        <div class="more-hotel">
            <h3>هتل های بیشتر</h3>
            <div class="m-hotel">
                <img src="/images/esfahan/photo_2023-07-30_23-02-51.jpg">
                <div class="text-h">
                    <p>450000 تومان/هر شب</p>
                    <a href="./parsyan-tehran.html"><p>هتل کوثر پارسیان</p></a>
                    <h5>اصفهان</h5>
                </div>
            </div>
            <div class="m-hotel">
