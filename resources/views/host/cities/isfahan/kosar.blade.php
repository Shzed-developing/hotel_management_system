@component('host.layouts.content')
    ...
    @endslot
    <div class="hotel1">
        <h2>هتل کوثر پارسیان</h2>
        <div class="starhotel">
            <img src="/images/star_2893811.png">
            <p>4ستاره</p>
        </div>
        <h5>اصفهان، بلوار ملت، مقابل سی و سه پل</h5>
    </div>
    <div class="hotel-box">
        <div class="hotel-v">
            <h2>توضیحات</h2>
            <p>این هتل در سال 1389 تاسیس شده است.</p>
            <h2>ویژگی ها</h2>
            <div class="icon-v">
        ...
        <div class="images-h">
            <img src="/images/esfahan/photo_2023-07-30_23-01-55.jpg">
            <img src="/images/esfahan/photo_2023-07-30_23-02-07.jpg">
            <img src="/images/esfahan/photo_2023-07-30_23-02-14.jpg">
            <img src="/images/esfahan/photo_2023-07-30_23-02-39.jpg">
        </div>
        <div class="more-hotel">
            <h3>هتل های بیشتر</h3>
            <div class="m-hotel">
                <img src="/images/esfahan2/toluekhorshid-esf.jpg">
                <div class="text-h">
                    <p>280000 تومان/هر شب</p>
                    <a href="./toloe-esfahan.html"><p>هتل طلوع خورشید</p></a>
                    <h5>اصفهان</h5>
                </div>
            </div>
            <div class="m-hotel">
                <img src="/images/esfahan3/pirozi-hotel-esf.jpg">
                <div class="text-h">
                    <p>500000 تومان/هر شب</p>
                    <a href="./pirozi-esfahan.html"><p>هتل پیروزی</p></a>
                    <h5>اصفهان</h5>
                </div>
            </div>
        </div>
