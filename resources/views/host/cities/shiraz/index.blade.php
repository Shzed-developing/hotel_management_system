@component('host.layouts.content')
    ...
    <div class="hotels">
        <div class="hotel-grid">
            <div class="hotel-1">
                <img src="/images/shiraz/Shiraz-Zandiyeh-hotel.jpg" alt="hotel1">
                <div class="star">
                    <img src="/images/star_2893811.png">
                    <p>4ستاره</p>
                </div>
                <a href="{{ route('host.city.shiraz.zandye') }}"><h2>هتل زندیه</h2></a>
                <p>شیراز</p>
                <p>450000 تومان/هر شب</p>
            </div>
            <div class="hotel-2">
                <img src="/images/shiraz3/bh-hotel-shiraz.jpg" alt="hotel2">
                <div class="star">
                    <img src="/images/star_2893811.png">
                    <p>3ستاره</p>
                </div>
                <a href="{{ route('host.city.shiraz.bh') }}"><h2>هتل بین الحرمین</h2></a>
                <p>شیراز</p>
                <p>380000 تومان/هر شب</p>
            </div>
            <div class="hotel-3">
                <img src="/images/shiraz2/chamran-hotel-shiraz.jpg" alt="hotel3">
                <div class="star">
                    <img src="/images/star_2893811.png">
                    <p>4ستاره</p>
                </div>
                <a href="{{ route('host.city.shiraz.chamran') }}"><h2>هتل چمران</h2></a>
                <p>شیراز</p>
