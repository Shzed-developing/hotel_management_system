@component('host.layouts.content')
    ...
    <div class="hotel1">
        ...
        <h5>شیراز، خیابان هجرت، پشت ارگ کریم‌خان</h5>
    </div>
    <div class="hotel-box">
        <div class="hotel-v">
            <h2>توضیحات</h2>
            <p>این هتل در سال 1379 تاسیس شده است.</p>
            <h2>ویژگی ها</h2>
            <div class="icon-v">
        ...
        <div class="images-h">
            ...
            <img src="/images/shiraz/photo_2023-07-30_14-11-17.jpg">
            <img src="/images/shiraz/photo_2023-07-30_14-11-12.jpg">
            <img src="/images/shiraz/photo_2023-07-30_14-11-04.jpg">
        </div>
