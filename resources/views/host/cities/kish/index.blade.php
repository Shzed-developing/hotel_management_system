@component('host.layouts.content')
    ...
    <div class="hotels">
        <div class="hotel-grid">
            <div class="hotel-1">
                <img src="/images/Kish-Panaroma-hotel.jpg" alt="hotel1">
                <div class="star">
                    <img src="/images/star_2893811.png">
                    <p>5ستاره</p>
                </div>
                <a href="{{ route('host.city.kish.panorama') }}"><h2>هتل پانوراما</h2></a>
                <p>کیش</p>
                <p>250000 تومان/هر شب</p>
            </div>
            <div class="hotel-2">
                <img src="/images/kish2/shaygan-hotel-kish.jpg" alt="hotel2">
                <div class="star">
                    <img src="/images/star_2893811.png">
                    <p>4ستاره</p>
                </div>
                <a href="{{ route('host.city.kish.shayegan') }}"><h2>هتل شایگان</h2></a>
                <p>کیش</p>
                <p>880000 تومان/هر شب</p>
            </div>
            <div class="hotel-3">
                <img src="/images/kish3/shayan-kish-hotel.jpg" alt="hotel3">
                <div class="star">
                    <img src="/images/star_2893811.png">
                    <p>5ستاره</p>
                </div>
                <a href="{{ route('host.city.kish.shayan') }}"><h2>هتل شایان</h2></a>
                <p>کیش</p>
