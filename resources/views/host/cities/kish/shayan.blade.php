@component('host.layouts.content')
    ...
    <div class="hotel1">
        ...
        <h5>جزیره کیش، میدان ساحل، بلوار ساحل</h5>
    </div>
    <div class="hotel-box">
        <div class="hotel-v">
            <h2>توضیحات</h2>
        ...
        <div class="images-h">
            <img src="/images/kish3/هتل-شایان-کیش-سوئیت-2.jpg">
            <img src="/images/kish3/هتل-شایان-کیش-سوئیت.jpg">
            <img src="/images/kish3/photo_2023-07-30_23-03-55.jpg">
            <img src="/images/kish3/photo_2023-07-30_23-03-33.jpg">
        </div>
