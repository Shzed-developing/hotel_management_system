@component('host.layouts.content')
    @slot('navbar')
        <div>
            <a href="./admin.html"><img class="logo" src="/images/logo1.jpg" alt="reservationhotel" /></a>
        </div>
        <nav>
            <ul class="header-ul">
                ...
                <li>
                    <a href="./host-profile.html">پروفایل</a>
                </li>
                <li>
    ...
    @endslot
    <div class="hotel1">
        <h2>هتل پارسیان استقلال</h2>
        <div class="starhotel">
            <img src="/images/star_2893811.png">
            <p>4ستاره</p>
        </div>
        <h5>تهران، تقاطع بزرگراه شهید چمران و خیابان ولیعصر (عج)</h5>
    </div>
    <div class="hotel-box">
        <div class="hotel-v">
            <h2>توضیحات</h2>
            <p>این هتل در سال 1378 تاسیس شده است.</p>
            <h2>ویژگی ها</h2>
            <div class="icon-v">
        ...
        <div class="images-h">
            <img src="/images/tehran2/photo_2023-07-30_23-05-15.jpg">
            <img src="/images/tehran2/photo_2023-07-30_23-04-55.jpg">
            <img src="/images/tehran2/photo_2023-07-30_23-04-52.jpg">
            <img src="/images/tehran2/photo_2023-07-30_23-04-44.jpg">
        </div>
        <div class="more-hotel">
            <h3>هتل های بیشتر</h3>
            <div class="m-hotel">
                <img src="/images/tehran/espinaspalas-tehran.jpg">
                <div class="text-h">
                    <p>550000 تومان/هر شب</p>
                    <a href="./espinas-tehran.html"><p>هتل اسپیناس</p></a>
                    <h5>تهران</h5>
                </div>
            </div>
            <div class="m-hotel">
                <img src="/images/tehran3/Tehran-Espinas-hotel.jpg">
                <div class="text-h">
                    <p>800000 تومان/هر شب</p>
                    <a href="./palas-tehran.html"><p>هتل اسپیناس پالاس</p></a>
                    <h5>تهران</h5>
                </div>
            </div>
        </div>
