@component('host.layouts.content')
    ...
    <div class="hotel1">
        ...
        <h5>جزیره کیش، ابتدای بلوار رودکی</h5>
    </div>
    <div class="hotel-box">
        <div class="hotel-v">
            <h2>توضیحات</h2>
            <p>این هتل در سال 1393 تاسیس شده است.</p>
            <h2>ویژگی ها</h2>
            <div class="icon-v">
        ...
        <div class="images-h">
            <img src="/images/kish2/photo_2023-07-30_22-59-18.jpg">
            <img src="/images/kish2/photo_2023-07-30_22-59-25.jpg">
            <img src="/images/kish2/photo_2023-07-30_23-00-36.jpg">
            <img src="/images/kish2/photo_2023-07-30_23-01-08.jpg">
        </div>
        <div class="more-hotel">
            ...
            <div class="m-hotel">
                ...
                <div class="text-h">
                    ...
                    <a href="./panorama-kish.html"><p>هتل پانوراما</p></a>
                    <h5>کیش</h5>
                </div>
            </div>
            <div class="m-hotel">
        ...
        <div class="coments-h">
            ...
            <div class="users-h">
                <div class="user1">
                    ...
                    <h3>کاربر شماره یک</h3>
                    <p>5-فروردین-1402</p></br>
                    <div class="user-text">
