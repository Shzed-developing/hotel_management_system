@component('host.layouts.content')
    ...
    @endslot
    <div class="hotel1">
        <h2>هتل بین الحرمین</h2>
        <div class="starhotel">
            <img src="/images/star_2893811.png">
            <p>3ستاره</p>
        </div>
        <h5>شیراز، خیابان حسینی، میدان آستانه، خیابان بین الحرمین، جنب شورای شهر</h5>
    </div>
    <div class="hotel-box">
        <div class="hotel-v">
            <h2>توضیحات</h2>
        ...
        <div class="images-h">
            <img src="/images/shiraz3/photo_2023-07-30_23-10-01.jpg">
            <img src="/images/shiraz3/photo_2023-07-30_23-09-51.jpg">
            <img src="/images/shiraz3/photo_2023-07-30_23-09-46.jpg">
            <img src="/images/shiraz3/photo_2023-07-30_23-09-35.jpg">
        </div>
        <div class="more-hotel">
            ...
            <div class="m-hotel">
                <img src="/images/shiraz2/chamran-hotel-shiraz.jpg">
                <div class="text-h">
                    <p>400000 تومان/هر شب</p>
                    <a href="./chamran-shiraz.html"><p>هتل چمران</p></a>
                    <h5>شیراز</h5>
                </div>
            </div>
        </div>
