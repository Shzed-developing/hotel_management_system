@component('host.layouts.content')
    ...
    <div class="hotel1">
        ...
        <h5>بندرانزلي، كيلومتر ۵ جاده انزلي به آستارا، جنب نمايشگاه</h5>
    </div>
    <div class="hotel-box">
        <div class="hotel-v">
            <h2>توضیحات</h2>
        ...
        <div class="images-h">
            <img src="/images/gilan/photo_2023-07-30_23-12-39.jpg">
            <img src="/images/gilan/photo_2023-07-30_23-12-48.jpg">
            <img src="/images/gilan/photo_2023-07-30_23-12-51.jpg">
            <img src="/images/gilan/photo_2023-07-30_23-13-03.jpg">
        </div>
        <div class="more-hotel">
            ...
            <div class="m-hotel">
                ...
                <div class="text-h">
                    ...
                    <a href="./arka-gilan.html"><p>هتل آرکا</p></a>
                    <h5>بندرانزلی</h5>
                </div>
            </div>
            <div class="m-hotel">
                <img src="/images/gilan3/pamchal-hotel-kish.jpg">
                <div class="text-h">
                    <p>480000 تومان/هر شب</p>
                    <a href="./palas-tehran.html"><p>هتل پامچال</p></a>
                    <h5>رشت</h5>
                </div>
            </div>
        </div>
