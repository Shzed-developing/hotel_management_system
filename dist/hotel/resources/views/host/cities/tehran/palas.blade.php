@component('host.layouts.content')
    ...
    @endslot
    <div class="hotel1">
        <h2>هتل اسپیناس پالاس</h2>
        <div class="starhotel">
            <img src="/images/star_2893811.png">
            <p>5ستاره</p>
        </div>
        <h5>تهران، سعادت‌آباد، میدان بهرود، خیابان ۳۳، شماره ۲۱</h5>
    </div>
    <div class="hotel-box">
        <div class="hotel-v">
            <h2>توضیحات</h2>
        ...
        <div class="images-h">
            ...
            <img src="/images/tehran3/LuxurySuite02.jpg">
            <img src="/images/tehran3/JuniorSuite.jpg">
            <img src="/images/tehran3/aaa3.jpg">
        </div>
