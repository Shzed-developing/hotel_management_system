@component('host.layouts.content')
    ...
    <div class="hotels">
        <div class="hotel-grid">
            <div class="hotel-1">
                <img src="/images/tehran/espinaspalas-tehran.jpg" alt="hotel1">
                <div class="star">
                    <img src="/images/star_2893811.png">
                    <p>5ستاره</p>
                </div>
                <a href="{{ route('host.city.tehran.espinas') }}"><h2>هتل اسپیناس</h2></a>
                <p>تهران</p>
                <p>550000 تومان/هر شب</p>
            </div>
            <div class="hotel-2">
                <img src="/images/tehran2/restaghlal-hotel-tehran.jpg" alt="hotel2">
                <div class="star">
                    <img src="/images/star_2893811.png">
                    <p>4ستاره</p>
                </div>
                <a href="{{ route('host.city.tehran.parsyan') }}"><h2>هتل پارسیان استقلال</h2></a>
                <p>تهران</p>
                <p>480000 تومان/هر شب</p>
            </div>
            <div class="hotel-3">
                <img src="/images/tehran3/Tehran-Espinas-hotel.jpg" alt="hotel3">
                <div class="star">
                    <img src="/images/star_2893811.png">
                    <p>5ستاره</p>
                </div>
                <a href="{{ route('host.city.tehran.palas') }}"><h2>هتل اسپیناس پالاس</h2></a>
                <p>تهران</p>
