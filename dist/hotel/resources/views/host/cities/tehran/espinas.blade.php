@component('host.layouts.content')
    ...
    <div class="hotel1">
        ...
        <h5>تهران، سعادت آباد، انتهای بزرگراه یادگار امام، میدان بهرود، خیابان عابدی، کوچه ۳۳</h5>
    </div>
    <div class="hotel-box">
        <div class="hotel-v">
            <h2>توضیحات</h2>
            <p>این هتل در سال 1385 تاسیس شده است.</p>
            <h2>ویژگی ها</h2>
            <div class="icon-v">
        ...
        <div class="images-h">
            ...
            <img src="/images/tehran/photo_2023-07-30_14-08-37.jpg">
            <img src="/images/tehran/photo_2023-07-30_14-09-00.jpg">
            <img src="/images/tehran/photo_2023-07-30_14-08-42.jpg">
        </div>
        <div class="more-hotel">
            <h3>هتل های بیشتر</h3>
            <div class="m-hotel">
                <img src="/images/tehran2/restaghlal-hotel-tehran.jpg">
                <div class="text-h">
                    <p>580000 تومان/هر شب</p>
                    <a href="./parsyan-tehran.html"><p>هتل پارسیان استقلال</p></a>
                    <h5>تهران</h5>
                </div>
            </div>
            <div class="m-hotel">
