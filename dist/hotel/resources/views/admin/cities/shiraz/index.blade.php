    ...
    <div class="hotels">
        <div class="hotel-grid">
            <div class="hotel-1">
                ...
                <a href="{{ route('admin.city.shiraz.zandye') }}"><h2>هتل زندیه</h2></a>
                <p>شیراز</p>
            ...
            <div class="hotel-2">
                ...
                <a href="{{ route('admin.city.shiraz.bh') }}"><h2>هتل بین الحرمین</h2></a>
                <p>شیراز</p>
            ...
            <div class="hotel-3">
                ...
                <a href="{{ route('admin.city.shiraz.chamran') }}"><h2>هتل چمران</h2></a>
                <p>شیراز</p>
