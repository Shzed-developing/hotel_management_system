    ...
    <div class="hotels">
        <div class="hotel-grid">
            <div class="hotel-1">
                ...
                <a href="{{ route('admin.city.tehran.espinas') }}"><h2>هتل اسپیناس</h2></a>
                <p>تهران</p>
            ...
            <div class="hotel-2">
                ...
                <a href="{{ route('admin.city.tehran.parsyan') }}"><h2>هتل پارسیان استقلال</h2></a>
                <p>تهران</p>
            ...
            <div class="hotel-3">
                ...
                <a href="{{ route('admin.city.tehran.palas') }}"><h2>هتل اسپیناس پالاس</h2></a>
                <p>تهران</p>
