    ...
    <div class="hotels">
        <div class="hotel-grid">
            <div class="hotel-1">
                ...
                <a href="{{ route('admin.city.kish.panorama') }}"><h2>هتل پانوراما</h2></a>
                <p>کیش</p>
            ...
            <div class="hotel-2">
                ...
                <a href="{{ route('admin.city.kish.shayegan') }}"><h2>هتل شایگان</h2></a>
                <p>کیش</p>
            ...
            <div class="hotel-3">
                ...
                <a href="{{ route('admin.city.kish.shayan') }}"><h2>هتل شایان</h2></a>
                <p>کیش</p>
