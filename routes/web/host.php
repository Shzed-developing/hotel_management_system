...
Route::resource('profile', \App\Http\Controllers\Host\Profile\ProfileController::class);
Route::prefix('profilee')->group(function () {
    Route::resource('hotel', \App\Http\Controllers\Host\Profile\HotelController::class);
    Route::resource('order', \App\Http\Controllers\Host\Profile\OrderController::class);
    Route::resource('cashhost', \App\Http\Controllers\Host\Profile\CashHostController::class);
});
